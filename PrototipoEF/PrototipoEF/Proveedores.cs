...
namespace PrototipoEF
{
	...
	{
		string usuario = "";
		public Proveedores(string usuarioActivo)
		{
			InitializeComponent();
			usuario = usuarioActivo;
			string[] alias = { "Codigo", "Nombres", "Dirección","Teléfono", "Nit", "Estado" }; // Arreglo de nombres para campos
			...
			//navegador1.asignarComboConTabla("marcas", "nombre_marca", 1);  //navegador1.asignarComboConTabla("tabla", "campo", 0); // 0 o 1 en modo, 0 pone el id y 1 coloca el nombre y consulta el id
			navegador1.asignarTabla("proveedores"); // tabla principal
			navegador1.asignarNombreForm("Registro de Proveedores"); // Titulo y nombre del form
		}
